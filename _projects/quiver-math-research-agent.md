...
<div class="text-center mb-4">
  <a href="https://marketplace.visualstudio.com/items?itemName=Quiver-Math.quiver-math-research-agent" target="_blank" class="btn btn-primary btn-lg">
    View in VS Code Marketplace
  </a>
</div>
<div class="text-center mb-4">
  <a href="https://github.com/andyzengmath/Quiver-Math-Research-Agent" target="_blank" class="btn btn-secondary btn-sm">
    GitHub Repository
  </a>
</div>

## About the Quiver Math Research Agent
